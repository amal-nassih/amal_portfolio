...
const Work = () => {
  ...
  const [activeFilter, setFilterActive] = useState('All');
  ...
  return (
    <>
       <h2 className='head-text'>
            Some things I've Build :: <span> My projects Section </span>
       </h2>

       <div className='app__work-filter'>

        {['Javascript','ReactJs','Spring framework','Laravel','PHP','Python','All'].map((item,index)=>(
          <div
            key={index}
